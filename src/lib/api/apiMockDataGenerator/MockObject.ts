...
// type ScalarType = "Int" | "Float" | "ID" | "String" | "Boolean" | "Custom" | "AWSURL" | "AWSTimestamp" | "AWSEmail" | "AWSDateTime" | "AWSTime"|"AWSJSON" | "AWSPhone" | "AWSIPAddress"|"AWSDate"
...
//           new AWSTDateObjectRequest(graphQLSchema, request, _isArray))
//       }
//        else if (this.isEnum(type)) {
//         this.objectRequests.push(new EnumObjectRequest(graphQLSchema, request, _isArray));
...
//   write(object: ArgAndResponseType['response']): void {
//     if (this.isArray) {
//       object[this.responseField.name] = ["2021-11-08", "2021-10-07", "2011-1-28"];
//     } else {
//       object[this.responseField.name] = "2021-11-08";
//     }
//   }
// }
// class AWSEmailObjectResponse extends ObjectResponse {
...
//   }
// }
// class AWSTDateObjectRequest extends ObjectRequest {
//   private requestField: GraphQLArgument
//   private isArray?: boolean;
//   constructor(graphQLSchema: GraphQLSchema, requestField: GraphQLArgument, isArray: boolean) {
//     super(graphQLSchema);
...
//   write(object: ArgAndResponseType['arguments']): void {
//     if (this.isArray) {
//       object[this.requestField.name] = ["2021-11-08", "2021-10-07", "2011-1-28"];
//     } else {
//       object[this.requestField.name] = "2021-11-08";
//     }
//   }
// }
// class AWSEmailStampObjectRequest extends ObjectRequest {
