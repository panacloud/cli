...
5. next run the following command to deploy the project to AWS `npm run deploy-prd`.
...
![alt AWS AppSync Console](static/create  "Adding data using AWS AppSync Console")
